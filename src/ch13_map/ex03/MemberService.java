...
public class MemberService {
    ...
    public void memberFind() {
        Map<Long, MemberDTO> memberDTOMap = memberRepository.memberfind();
    ...
    public void memberUpdate() {
        if (loginEmail != null) {
            ...
            if (memberDTO) {
                ...
                boolean result =   memberRepository.memberUpdate(memberEmail,memberPassword,memberName,memberNumber);
