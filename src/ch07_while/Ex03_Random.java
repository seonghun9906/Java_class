...
public class Ex03_Random {
    public static void main(String[] args) {
        ...
        //메서드 : 어떤 출력(리턴 타입) => double 활용 (0.0< ~ <1.0)
        ...
        System.out.println((int)(Math.random()*10)); //(0 < ~ < 9 정수 출력
        System.out.println((int)(Math.random()*10) +1); //(1 < ~ <10 정수 출력
        System.out.println((int)(Math.random()*45) +1); //(1 < ~ <45 정수 출력
        // 형변환
        int int1 = 10;
